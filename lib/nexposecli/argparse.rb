...
if $0 == __FILE__
    ...
    args = %q{
        ...
        - name                  : things
          short                 : t
          desc                  : A bunch of things
          proc                  : split(/,/)
          required              : true
        
    }

    ap = ArgParse.new( args )

    begin
        args = ap.parse
    rescue ArgParse::InvalidArgument, ArgParse::MissingArgument, ArgParse::ExtraneousArgument => e
        STDERR.puts e
